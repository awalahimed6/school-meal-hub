...
//               <AvatarImage src="/awal.jpg" alt="Awalex" />
//               <AvatarFallback className="text-4xl font-bold">A</AvatarFallback>
//             </Avatar>
...
// --- FIX #1: Import the Avatar components ---
...
export const DeveloperPortfolio = () => {
  ...
  return (
    <>
      {/* Floating Action Button - positioned above the chatbot */}
      <Button
        onClick={() => setIsOpen(true)}
        className="fixed bottom-24 right-6 z-40 h-14 w-14 rounded-full shadow-2xl hover:scale-110 transition-transform bg-gradient-to-br from-primary to-secondary"
        size="icon"
      >
        <Code className="h-6 w-6" />
      </Button>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="flex flex-col items-center gap-6 py-4">
            ...
            {/* --- FIX #2: Wrap the Avatar and the green dot in a relative div --- */}
            <div className="relative">
              <Avatar className="h-28 w-28 border-4 border-primary">
                <AvatarImage src="/awal.jpg" alt="Awalex" />
                <AvatarFallback className="text-4xl font-bold">A</AvatarFallback>
