  ...
  return (
    <ProtectedRoute allowedRoles={["student"]}>
      <div className="min-h-screen bg-background">
        {/* Header */}
        <header className="sticky top-0 z-40 overflow-hidden bg-primary text-primary-foreground">
          <div className="relative container mx-auto px-4">
            ...
            <div className="flex items-center justify-between pt-3 pb-1">
              ...
              <div className="flex items-center gap-0.5">
                ...
                <Button
                  ...
                  className="rounded-full h-8 w-8 text-primary-foreground/80 hover:text-primary-foreground hover:bg-primary-foreground/10"
                  title="Sign Out"
                >
            ...
            <div className="flex items-center gap-4 pb-6 pt-1">
              <Avatar className="h-14 w-14 border-2 border-primary-foreground/30">
                <AvatarFallback className="bg-primary-foreground/15 text-primary-foreground font-bold">
                  {initials}
                </AvatarFallback>
              </Avatar>
              <div className="flex-1 min-w-0">
                ...
                {student && (
                  <div className="flex flex-wrap items-center gap-2 mt-1">
                    <span className="text-[11px] font-medium text-primary-foreground/70 bg-primary-foreground/10 px-2 py-0.5 rounded-md">
        ...
        <nav className="fixed bottom-5 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-md">
          <div className="bg-card/95 backdrop-blur-xl border border-border rounded-2xl shadow-2xl px-2 py-2">
